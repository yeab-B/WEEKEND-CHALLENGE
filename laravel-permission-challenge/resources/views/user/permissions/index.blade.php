                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        @can('create permission')
                            <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#createPermissionModal">
                ...
                <form method="GET" id="permission-search-form" class="mb-3">
                    <div class="row g-3">
                        <div class="col-xxl-3 col-lg-6">
                            <input id="permission-search" name="search" class="form-control bg-dark text-light border-secondary" placeholder="Search..." value="{{ request('search') }}">
                        </div>
                        <div class="col-xxl-2 col-lg-3">
                            <select name="per_page" id="permission-per_page" class="form-select bg-dark text-light border-secondary">
                        ...
                        <div class="col-xxl-2 col-lg-4">
                            <a href="{{ route('permissions.index') }}" class="btn btn-outline-light w-100">
